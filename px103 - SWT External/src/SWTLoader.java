...
//			System.out.println( "Done." );
			...
			final File fileSwtLib;
			
			if (!bWin) {
//				fileSwtLib = new File( "/Share/Development/Export/swt.jar" );
				fileSwtLib = new File( "/Share/Resources/lib/Lnx32/swt.jar" );
			} else {
				fileSwtLib = new File( "S:\\Resources\\lib\\Win32\\swt.jar" );
			}
			
			addJarToClasspath( fileSwtLib );
...
//				| InvocationTargetException e ) {
		...
		if ( !bWorking ) {
			try {
				...
				System.err.println( "Failed second attempt." );
			}
		}
	}
